              ...
              {rules.length > 0 ? (
                rules.map((rule) => (
                  <TableRow key={rule.id} hover>
                    ...
                    <TableCell>
                      <Chip label={rule.customer_type} size="small" color={rule.customer_type === 'POSTPAID' ? 'primary' : rule.customer_type === 'PREPAID' ? 'secondary' : 'default'} />
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <Switch checked={rule.is_active} onChange={() => handleToggleActive(rule.id, rule.is_active)} color="success" />
                    </TableCell>
                    <TableCell align="center">
                      <Tooltip title="Edit">
                        <IconButton size="small" color="primary" onClick={() => handleOpenForm(rule)}>
                          <Edit />
                        </IconButton>
                      </Tooltip>
